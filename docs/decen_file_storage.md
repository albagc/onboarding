...
-  **Akash**: is a decentralized, open-source cloud services marketplace and self-described “DeCloud for DeFi.” Akash Network is a <a href="https://docs.cosmos.network/v0.44/intro/overview.html" targe="_blank">Cosmos</a>-based Proof-of-Stake (PoS) blockchain built with interoperability in mind using the Cosmos SDK.
